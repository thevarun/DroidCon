 ...
 * new Post object. It lets the user input a 
 * post title, and take a 
 * photo. If there is already a photo associated
 * with this post, it will be displayed in the 
...
public class NewPostFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup parent,
		...
		saveButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Post meal = ((NewPostActivity) getActivity()).getCurrentPost();

				// When the user clicks "Save," upload the meal to Parse
				// Add data to the meal object:
				meal.setTitle(postTitle.getText().toString());
